...
- P-009: 외부 캘린더 연동 (Google Calendar, iCloud)
...
### Phase 6: iCloud CalDAV 연동
**Goal**: iCloud 캘린더 연동 (CalDAV + 앱 암호)
**Estimated Time**: 2시간
**Actual Time**: 0.3시간
**Status**: ✅ Complete
...
**🔴 RED: Write Failing Tests First**
- [x] **Test 6.1**: iCloud 서비스 테스트
  - `test_validate_credentials`: 자격증명 검증
  - `test_save_icloud_credentials`: 앱 암호 저장
  - `test_list_calendars`: 캘린더 목록 조회

- [x] **Test 6.2**: Slack 모달 테스트
  - `test_open_icloud_modal`: 모달 열기
  - `test_submit_credentials`: 자격증명 제출

**🟢 GREEN: Implement to Make Tests Pass**
- [x] **Task 6.3**: caldav 라이브러리 설치
  - `poetry add caldav`

- [x] **Task 6.4**: iCloudService 구현
  - File: `src/core/auth/icloud_service.py`
  - CalDAV 클라이언트 연결
  - 자격증명 검증 및 저장

- [x] **Task 6.5**: Slack 모달 구현
...
| Phase 6 | 2시간 | 0.3시간 | -1.7시간 ✅ |
| **Total** | **17시간** | **2.1시간** | **-14.9시간** 🚀 |
...
- [PLAN_memory_system.md](./PLAN_memory_system.md) - 메모리 시스템 (P-007)
- [PLAN_calendar_integration.md](./PLAN_calendar_integration.md) - 캘린더 연동 (P-009, 이 계획 완료 후)
...
- [x] P-009 Blocked 해제 (PLAN_master.md에 등록됨)
